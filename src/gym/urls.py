...
urlpatterns = [
    ...
    path("actividades/<pk>", actividades_detalle, name="detalle_actividad"),
    ...
    path("socios/<pk>", socios_detalle, name="detalle_socio"),
    ...
    path("planes/<pk>", planes_detalle, name="detalle_plan")
]
